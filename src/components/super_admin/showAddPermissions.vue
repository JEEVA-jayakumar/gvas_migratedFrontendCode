     ...
     <q-dialog
        ...
        >
           <form> 
            ...
            <div class="q-px-md">
              <div class="q-pa-sm">
                <div class="column gutter-sm q-py-lg items-center bottom-border">

                  <div class="col-auto">
                    <img src="https://png.icons8.com/color/260/person-female.png" class="avatar">
                  </div>
