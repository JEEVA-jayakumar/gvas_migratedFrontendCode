       ...
       <!-- @hide="emitfnshowAddPartner()"
        ...
        <form>
          <div class="column group">
            <div class="col-md-12">
              <div class="text-h6 text-weight-regular"><p align="center"><strong>Download Aggregator Lost Or Stolen File</strong></p></div>
            </div>
            <div class="col-md-12">
          ...
          <div class="col-md-12 group" align="right">
              ...
              >Cancel</q-btn>
              <q-btn align="right" @click="downloadLostOrStolenList(formData)" :disabled="submitDisabled" color="purple-9">Download</q-btn>" class="</div>
          </div>
        </form>
      </q-dialog>
    </div>
