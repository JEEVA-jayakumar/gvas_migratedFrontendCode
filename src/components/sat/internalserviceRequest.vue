                            ...
                            <q-tr :props="props" class="bottom-border">
                                ...
                                <q-td key="serviceReqTicketId" :props="props">
                                    <q-checkbox checked-icon="fas fa-chevron-up" unchecked-icon="fas fa-chevron-down"
                                        ...
                                        @update:model-value="props.row.expand = !props.row.expand" />
                                ...
                                <q-td colspan="100%">
                                  <div class="row q-col-gutter-sm">
                                    <div class="col-3">
                                        ...
                                        <div class="text-left" v-if="props.row.subTicketsList && props.row.subTicketsList.length > 0">
        ...
        return {
            ...
            columnDataclosed: [
                ...
                },
                {
                    ...
                    label: "AssignedTo",
                    align: "left",
                    field: row => row.assignedTo ? row.assignedTo.name : "NA",
                    sortable: false,
                },
                {
                    name: "crmRemark",
