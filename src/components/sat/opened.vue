...
<q-tab-panel name="unAssigned">
                    <q-table :rows="internalUnAssignedTableData" :columns="columnDataUnassigned"
                        ...
                        <template v-slot:body-cell-serviceRequestSubTicketStatus="props"><q-td :props="props">
                        ...
                        <template v-slot:body-cell-serviceRequestTicketStatus="props"><q-td :props="props">
                            <span class="label text-positive"
                        ...
                        <template v-slot:body-cell-kaptureDueDate="props"><q-td :props="props">{{ $moment(props.row.kaptureDueDate == null ? "NA" : : : props.row.kaptureDueDate).format("Do MMM Y") }}</q-td></template>
                        <template v-slot:body-cell-appointmentDate="props"><q-td :props="props">{{ $moment(props.row.appointmentDate == null ? "NA" : : : props.row.appointmentDate).format("Do MMM Y") }}</q-td></template>
                        <template v-slot:body-cell-courierDueDate="props"><q-td :props="props">{{ $moment(props.row.courierDueDate == null ? "NA" : : : props.row.courierDueDate).format("Do MMM Y") }}</q-td></template>
                        <template v-slot:body-cell-scheduleDate="props"><q-td :props="props">{{ props.row.scheduleDate
$moment(== null ? "NA" : : : props.row.scheduleDate).format("Do MMM Y")
                        }}</q-td></template>
                        <template slot="top">
                            <div class="col-md-5">
                    ...
                    <q-table :rows="internalAssignedTableData" :columns="columnDataAssigned"
                        ...
                        <template v-slot:body="props">
                            ...
                            <q-tr v-show="props.row.expand" :props="props" class="wordWrapCustom bottom-border">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">SubTicket Status
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">Implementation Form
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">Picture Of Shop
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">Old Sim Network
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">New Sim Network
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">Scan Sim Number
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
                                ...
                                <q-td>
                                    <div class="text-left text-caption text-grey-8 text-weight-medium">Paper Roll Count
                                    </div>
                                    <div class="text-left" v-if="props.row.subTicketsList.length > 0">
                                        <div v-for="col in props.row.subTicketsList" :key="col.serviceRequestType.id"
                                            :props="props">
...
export default {
    ...
    methods: {
        ...
        ajaxLoadAllLeadInfo1({ pagination, filter }) {
            ...
            this.FETCH_UNASSIGNED_SERVICE_REQUEST_DATAS({ pagination, filter }).then((res) => {
