    ...
    <div>
      ...
      <q-pull-to-refresh :distance="30"  inline>
        ...
        >
          ...
          <template v-slot:body-cell-createdAt="props"><q-td :props="props">{{ $moment(props.row.date).format("Do MMM Y") }}</q-td></template>
          ...
          <template v-slot:body-cell-verifiedFinanceStatus="props"><q-td :props="props">
            <span
          ...
          <template v-slot:body-cell-rejectLead="props"><q-td :props="props">
             <q-btn
