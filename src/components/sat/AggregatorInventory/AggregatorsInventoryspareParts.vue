    ...
    <q-page>
        ...
        <div>
            <div class="row bottom-border q-ma-md q-py-md">
                ...
                <div class="col-md-9 col-sm-12 col-xs-12">
                    <div v-if="regionSpareCount.length > 0" class="row">
                        <q-card class="border-radius-10 q-pa-md q-ma-md" color="purple-9" class="v-for="menu in regionSpareCount" :key="menu" height="35px" width="35px">
                            <div>
            ...
            <q-tabs v-model="selectedTab" class="shadow-1" color="grey-1" class="@select="goToSelectedTab">
                ...
                <q-tab color="dark" class="name="SoPodList"  label="So Pod List" />
...
<q-tab-panel name="allocatedSo">
          ...
          <q-table :rows="tableData2" table-class="customSATableClass" :columns="columns2" :filter="filterSearch2"
            :pagination="paginationControl2" :filter-method="myCustomSearchFilter" row-key="name" color="grey-9" class="@request="ajaxLoadAllLeadInfo2">
            <q-td v-slot:body-cell-createdAt="props" :props="props">{{
                props.row.created_date == null
                  ? "NA"
                  : props.row.created_date | moment("Do MMM Y")
                        ...
                        <div class="col-sm-3">
                            <div class="row">
                                <q-select filter clearable v-model="formData.allocate_so" @blur="v$.formData.allocate_so.$touch"
                                    ...
                                    radio color="grey-9" class=":options="regionBasedSo" @request="regionBasedSoLoad" />
                            </div>
                            <div class="col-md-7">
