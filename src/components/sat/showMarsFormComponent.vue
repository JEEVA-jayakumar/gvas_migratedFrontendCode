      ...
      <div id="rightSidePane" class="col-md-7 q-pa-xs block relative">
        <q-stepper color="purple-9" ref="stepper" contractable text alternative-labels>
            ...
            <q-step error-icon="warning" name="third" :error="businessInformationError" :order="3" title="Partners" v-if="showPartnerstab">
                <div v-for="(v,index) in v$.viewBinding.partnersArr.$each.$response.$data" :key="index" class="row q-my-xs gutter-sm" ref="parentElement">
                  <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="row group items-center">
                      ...
                      <div class="col-auto" v-if="Object.keys(v$.viewBinding.partnersArr.$each.$response.$data || {}).length > 1">
            ...
            <q-step error-icon="warning" name="seventh" :error="bankInformationError" :order="7" title="Bank & Collection" subtitle="Details">
              <div class="row q-mb-md gutter-sm items-center">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <q-select map-options emit-value placeholder="Choose from the below" color="grey-9" v-model="merchant.bankInformation.bankDetails.paymentMode" label="Payment mode" :options="paymnentModeOptions" />
                </div>
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <q-input color="grey-9"
              ...
              <div class="row gutter-sm items-center">
                ...
                <div class="col-md-6 col-sm-12 col-xs-12">
                  <q-select map-options emit-value clearable placeholder="Choose from the below" color="grey-9" v-model="merchant.bankInformation.collectionDetails.acquirerBank" label="Bank Name" :options="bankListSet" />
                </div>
              </div>
              <q-stepper-navigation>
...
export default {
  ...
  computed: {
    ...mapGetters("Mars_Parameters", [
      "SALES_PERSON_OPTIONS_MARS",
      "SHARING_PARTNER_OPTIONS_MARS",
      "MERCHANT_MCC_OPTIONS_MARS",
      "CITY_OPTIONS_MARS",
      "STATE_OPTIONS_MARS",
      "REGION_OPTIONS_MARS"
    ]),
  ...
  methods: {
    ...mapActions("Mars_Parameters", [
      "SALES_PERSON_FROM_MARS",
      "SHARING_PARTNER_FROM_MARS",
      "MERCHANT_MCC_FROM_MARS",
      "CITY_FROM_MARS",
      "STATE_FROM_MARS",
      "REGION_FROM_MARS"
    ]),
