    ...
    <!-- START: Total users -->
      <div>
        <div class="row">
          ...
          <!-- <div class="col-md-4">
            <q-input v-model="dateFilter" label="Select Date" type="date" class="q-mt-lg q-mr-lg" color="grey-9" />
          </div> -->
        </div>
        <div class="q-pa-lg">
          <div class="row">
            <div class="col-md-4">
              <q-card class="bigger q-ma-sm full-width" style="border: 1px solid #3b084b33">
                ...
                <q-card-section class="no-padding">
                  <div class="row group">
                    <div v-for="(roleItem,roleIndex) in item.role" :key="roleIndex" class="col-md-3 col-sm-6 col-xs-9">
                      <q-card class="bigger full-width">
                        <q-card-section class="relative-position">
