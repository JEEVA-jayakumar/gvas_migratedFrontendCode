    ...
    <q-page>
      <div class="row">
        ...
        <div class="col-md-5 col-sm-4 col-xs-12 q-pa-sm">
          <div class="text-h6 q-px-lg q-py-md text-weight-regular bottom-border text-grey-9"><strong>MARS API SYNC - STATE</strong>
          </div>
          ...
          <q-card-section>
              ...
              color="purple-9" class=":disabled="this.formData.tokenState == ''" toggle-color="primary" size="15px" label="Submit"
