  ...
  <q-page>
    <div>
      ...
      <!-- <div class="row bottom-border q-px-md q-py-md items-center text-weight-regular text-grey-9">
        ...
        <q-table table-class="customTableClass" :rows="this.getInventoryWithSOAggregatorList"  :columns="columns"
        ...
        ><template v-if="props && props.row">{{ $moment(props.row.device.modifyDate).format("Do MMM Y") }}</template></q-td>-->
          <q-td v-slot:body-cell-created_at="props" :props="props"><template v-if="props && props.row">{{
