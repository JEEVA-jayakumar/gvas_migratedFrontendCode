...
$moment(props.row.createdAt).format("Do MMM Y")
            ...
            <template v-slot:body-cell-Batch="props"><q-td :props="props">{{
              props.row.batchId == null ? 'NA' :
                props.row.batchId
            }}</q-td></template>
            <template v-slot:body-cell-Bank="props"><q-td :props="props">{{
              props.row.staticQrBank.name == null ? 'NA'
                :
                props.row.staticQrBank.name
            }}</q-td></template>
            <template v-slot:body-cell-Count="props"><q-td :props="props">{{
              props.row.count == null ? 'NA' :
                props.row.count
            }}</q-td></template>
            <template v-slot:body-cell-remainingCount="props"><q-td :props="props">{{
