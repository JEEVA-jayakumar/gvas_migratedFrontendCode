    ...
    <q-page>
        ...
        <div>
            ...
            <q-table row-key="name" :filter="filter" :rows="regionalItems" class="q-py-none" :columns="columns"
                ...
                <q-td v-slot:body-cell-region="props" :props="props"><template v-if="props && props.row">{{ props.row.region == null ?
                        'NA' : props.row.region.regionAreaName
                }}</template></q-td>
                <q-td v-slot:body-cell-device="props" :props="props"><template v-if="props && props.row">{{ props.row.device == null ?
