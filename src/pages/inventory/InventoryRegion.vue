    ...
    <q-page>
        ...
        <div>
            ...
            <q-table row-key="name" :filter="filter" :rows="regionalItems" class="q-py-none" :columns="columns"
                ...
                <template v-slot:body-cell-region="props"><q-td :props="props">{{ props.row.region == null ?
                        'NA' : props.row.region.regionAreaName
                }}</q-td></template>
                <template v-slot:body-cell-device="props"><q-td :props="props">{{ props.row.device == null ?
