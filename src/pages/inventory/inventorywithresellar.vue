  ...
  <q-page>
    <div>
      ...
      >
        ...
        <template v-slot:body-cell-createDate="props"><q-td :props="props">{{ $moment(props.row.createDate ==null? "NA" : props.row.createDate).format("Do MMM Y") }}</q-td></template>
        <template v-slot:body-cell-modifyDate="props"><q-td :props="props">{{ $moment(props.row.modifyDate ==null? "NA" : props.row.modifyDate).format("Do MMM Y") }}</q-td></template>
