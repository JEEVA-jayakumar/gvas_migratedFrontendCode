                ...
                <q-card class="border-radius-10 q-pa-md bg-purple-9 text-white">
                  <div class="row items-center justify-center">
                    <div class="col-lg-4 col-md-8 col-sm-12 items-center text-center">
                      <div class="q-display-1 sm-q-caption text-center">{{ exceptionCount.totalExceptionCount }}</div>
                    </div>
                    ...
                    <div class="col-lg-7 col-md-8 col-sm-12 items-center">
                      <div class="q-title sm-q-caption text-weight-light text-center">Exception</div>
                    </div>
                  </div>
                </q-card>
                <q-card class="q-py-md items-center">
                  <div class="row items-center text-center" style="min-height:75px">
                    <div class="col-md-4 q-my-xs">
                      ...
                      <q-chip clickable @click="retrieveLeadsList(exceptionCount.kycPendingLeadIds)"
                    ...
                    <div class="col-md-4 q-my-xs">
                      ...
                      <q-chip clickable @click="retrieveLeadsList(exceptionCount.pricingPendingLeadIds)"
            ...
            <div class="col-lg-4 col-md-6 col-sm-12">
              <div>
                <q-card class="border-radius-10 q-pa-md bg-purple-9 text-white">
                  <div class="row items-center justify-center">
                    <div class="col-lg-4 col-md-8 col-sm-12 items-center text-center">
                      <div class="q-display-1 sm-q-caption text-center">{{ regionalInventoryCount.totalDevice }}</div>
                    </div>
                    <div class="col items-center text-center full-height gt-md">
                      <div style="border-left:1px solid #fff;height: 35px !important;"></div>
                    </div>
                    <div class="col-lg-7 col-md-8 col-sm-12 items-center">
                      <div class="q-title sm-q-caption text-weight-light text-center">Stock Inventory (Bijlipay)
                      </div>
                    </div>
                  </div>
                </q-card>
              ...
              <div>
                <q-card class="border-radius-10 q-pa-md bg-purple-9 text-white">
                  <div class="row items-center justify-center">
                    ...
                    <div class="col-lg-7 col-md-8 col-sm-12 items-center">
                      <div class="q-title md-q-caption sm-q-caption text-weight-light text-center">Implementation
                      </div>
                    </div>
                  </div>
                </q-card>
                  ...
                  <div class="row items-center text-center" style="min-height:75px">
                    ...
                    <div class="col-md-6 q-my-xs">
                      <div class="q-caption text-negative">
                        <q-icon color="amber-9" name="fas fa-bell" />
            ...
            <div class="row q-col-gutter-x-xs q-col-gutter-y-xs items-center justify-center q-mt-md">
              <div class="col">
                <q-card class="border-radius-10 q-pa-md bg-purple-9 text-white">
                  <div class="row items-center justify-center">
                    <div class="col-lg-4 col-md-8 col-sm-12 items-center text-center">
                      <div class="q-display-1 sm-q-caption text-center">{{ aggregatorCount.totalDevice }}</div>
                    </div>
                    <div class="col items-center text-center full-height gt-md">
                      <div style="border-left:1px solid #fff;height: 35px !important;"></div>
                    </div>
                ...
                <q-card class="q-py-md items-center">
                  <div class="row items-center text-center" style="min-height:75px">
                    <div class="col-md-4 q-my-xs">
                      ...
                      <q-chip color="purple-9" text-color="white">{{ aggregatorCount.pendingDeviceCount }}</q-chip>
                    </div>
                    <div class="col-md-4 q-my-xs">
          ...
          <div class="row q-col-gutter-x-xs q-col-gutter-y-xs items-center justify-center q-mt-md">
            <div class="col">
              <q-card class="border-radius-10 q-pa-md bg-purple-9 text-white">
                <div class="row items-center justify-center">
                  <div class="col-lg-4 col-md-8 col-sm-12 items-center text-center">
                    <div class="q-display-1 sm-q-caption text-center">{{ serviceRequestCount.total }}</div>
                  </div>
                  <div class="col items-center text-center full-height gt-md">
                    <div style="border-left:1px solid #fff;height: 35px !important;"></div>
                  </div>
                  <div class="col-lg-7 col-md-8 col-sm-12 items-center">
                    <div class="q-title sm-q-caption text-weight-light text-center">Service Request</div>
                  </div>
                </div>
              </q-card>
              ...
              <q-card class="row border-radius-10 q-pa-md">
                <div class="col-6 q-py-md items-center">
                  <div class="col border-radius-10 q-pa-md" align="left">
                    <div class="q-title sm-q-caption text-weight-light text-center"><strong>Internal</strong></div>
                  </div>
                ...
                <div class="col-6 q-py-md items-center">
                  <div class="col border-radius-10 q-pa-md">
                    <div class="q-title sm-q-caption text-weight-light text-center"><strong>External</strong></div>
                  </div>
                  <div class="row text-center justify-center" style="min-height:75px">
                    <div class="col-md-4 q-my-xs">
                      <div class="q-caption text-grey-10">closed</div>
        ...
        <div class="col-lg-4">
          <div class="row q-col-gutter-x-xs q-col-gutter-y-xs items-center justify-center" style="min-height: 100px;">
            <div class="col-md-12 col-sm-12 col-xs-12">
              <q-card class="q-pa-sm full-height bg-orange text-white border-radius-10 vertical-middle items-center" align="center">
                <q-card-section>
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="row q-col-gutter-xs">
                <div class="col-lg-6 col-sm-6 col-xs-6" style="height:50%">
                  <q-card class="q-pa-sm bg-negative text-white border-radius-10" align="center">
                    <div class="row items-center justify-around q-pa-xs">
                      <div class="col-12">
                        <div class="q-subheading sm-q-caption text-white">
                ...
                <div class="col-lg-6 col-sm-6 col-xs-6" style="height:50%">
                  <q-card class="q-pa-sm bg-amber-9 text-white border-radius-10" align="center">
                    <div class="row items-center justify-around q-pa-xs">
                      <div class="col-12">
                        <div class="q-subheading sm-q-caption text-white">
                ...
                <div class="col-lg-4 col-sm-4 col-xs-4" style="height:50%">
                  <q-card class="q-pa-sm bg-blue-6 text-white border-radius-10" align="center">
                    <div class="row items-center justify-around q-pa-xs">
                      <div class="col-12">
                        <div class="q-subheading sm-q-caption text-white">
                          <small>WIP</small>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-4" style="height:50%">
                  <q-card class="q-pa-sm bg-positive text-white border-radius-10" align="center">
                    <div class="row items-center justify-around q-pa-xs">
                      <div class="col-12">
                        <div class="q-subheading sm-q-caption text-white">
                          <small>New</small>
                ...
                <div class="col-lg-4 col-sm-4 col-xs-4" style="height:50%">
                  <q-card class="q-pa-sm bg-purple-9 text-white border-radius-10" align="center">
                    <div class="row items-center justify-around q-pa-xs">
                      <div class="col-12">
                        <div class="q-subheading sm-q-caption text-white">
                          <small>Ops</small>
