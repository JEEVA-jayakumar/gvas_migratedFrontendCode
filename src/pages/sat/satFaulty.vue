  ...
  <q-page>
    ...
    <div>
      ...
      >
        ...
        <template v-slot:body-cell-deviceType="props"><q-td :props="props">{{props.row.device.name}}</q-td></template>
        <template v-slot:body-cell-serialNumber="props"><q-td :props="props">{{props.row.serialNumber}}</q-td></template>
