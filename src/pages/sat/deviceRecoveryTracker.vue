    ...
    return {
      ...
      columnDataAssigned: [
        ...
        },
        {
          ...
          label: "Merchant Name",
          align: "left",
          field: (row) => row.leadInformation?.leadName || row.qrLeadInformation?.merchantName || "NA",
          sortable: false,
        },
        {
          name: "mobile_number",
        ...
        },
        {
          ...
          label: "Assigned To",
          align: "left",
          field: (row) => row.recoveredBy ? (row.recoveredBy.name + " | " + row.recoveredBy.employeeID) : "NA",
          sortable: false,
        },
        {
