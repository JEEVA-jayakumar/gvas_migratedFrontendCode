    ...
    <div class="capitalize">
      <q-pull-to-refresh :distance="30" :handler="PullToRefresh" inline>
        ...
        >
          ...
          <template v-slot:body-cell-submitteSATDate="props"><q-td :props="props">
            <span class="label">{{ $moment(props.row.updatedAt).format("Do MMM Y") }}</span>
          </q-td></template>
          <template v-slot:body-cell-applicationNumber="props"><q-td :props="props">
            <span class="label capitalize">{{props.row.applicationNumber}}</span>
          </q-td></template>
          <template v-slot:body-cell-leadName="props"><q-td :props="props">
            <span class="label capitalize">{{props.row.leadName}}</span>
          </q-td></template>
          <template v-slot:body-cell-leadNumber="props"><q-td class="cursor-pointer"
            @click="toggleLeadInformation(props.row)"
            slot-scope="props"
            :props="props">
            <span class="label text-primary"># {{props.row.leadNumber}}</span>
          </q-td></template>
          <template v-slot:body-cell-createdBy="props"><q-td :props="props">
          ...
          <template v-slot:body-cell-verifiedStatus="props"><q-td :props="props">{{props.row.verifiedStatus}}</q-td></template>
