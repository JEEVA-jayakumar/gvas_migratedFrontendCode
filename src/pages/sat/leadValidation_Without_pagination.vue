    ...
    <div>
      ...
      <q-pull-to-refresh :distance="30" :handler="PullToRefresh" inline>
        ...
        >
          ...
          <template v-slot:body-cell-date="props"><q-td :props="props">{{ $moment(props.row.submitteSATDate).format("Do MMM Y") }}</q-td></template>
          ...
          <template v-slot:body-cell-so_name="props"><q-td :props="props">
            <span
              class="capitalize"
          ...
          <template v-slot:body-cell-finance_approval="props"><q-td :props="props">
            <span
