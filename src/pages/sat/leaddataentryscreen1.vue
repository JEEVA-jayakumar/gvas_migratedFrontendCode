        ...
        >
          <q-card>
            <q-card-section>
              ...
              <div class="row q-col-gutter-md content-stretch">
                <!-- Device -->
                <div class="col">
                  <q-card class="border-1 q-custom-class" flat bordered>
                    <q-card-section class="q-pa-sm bg-grey-4 bottom-border-dark">
                    ...
                    <q-card-section class="q-pa-sm text-grey-9">
                      <q-list separator dense>
                        <q-item>
                          <q-item-section>
                            <q-item-label class="q-caption">Plan</q-item-label>
                          </q-item-section>
                          <q-item-section side>
                            <q-item-label class="q-caption">{{formData.shortLead?.plan?.planName}}</q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item>
                          <q-item-section>
                            <q-item-label class="q-caption">Setup Fees</q-item-label>
                          </q-item-section>
                          <q-item-section side>
                            <q-item-label class="q-caption">Rs. {{formData.shortLead?.setupFees}}</q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item>
                          <q-item-section>
                            <q-item-label class="q-caption">Recurring Fees</q-item-label>
                          </q-item-section>
                          <q-item-section side>
                            <q-item-label class="q-caption">Rs. {{formData.shortLead?.recurringFees}}</q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item>
                          <q-item-section>
                            <q-item-label class="q-caption">Merchant Category</q-item-label>
                          </q-item-section>
                          <q-item-section side>
                            <q-item-label class="q-caption">{{formData.shortLead?.merchantCategory?.merchantCategoryName}}</q-item-label>
                          </q-item-section>
                        </q-item>
                      </q-list>
                    </q-card-section>
                ...
                <div v-if="formData.shortLead?.leadCategory == 2" class="col">
                  <div class="q-mb-sm" v-if="formData.shortLead?.kyc">
                    <q-card class="border-1" flat bordered>
                      <q-card-section class="q-pa-sm bg-grey-4 bottom-border-dark">
                  ...
                  <div class="q-mb-sm" v-if="formData.shortLead?.bankSubvention">
                    <q-card class="border-1" flat bordered>
                      <q-card-section class="q-pa-sm bg-grey-4 bottom-border-dark">
                  ...
                  <div class="q-mb-sm" v-if="formData.shortLead?.pricing">
                    <q-card class="border-1" flat bordered>
                      <q-card-section class="q-pa-sm bg-grey-4 bottom-border-dark">
                    ...
                    <q-card-section class="q-pa-sm text-grey-9">
                      <q-list dense>
                        <q-item class="q-pa-sm">
                          <q-item-section>
                            <q-item-label class="q-caption">Payment mode:</q-item-label>
                          </q-item-section>
                          <q-item-section side>
                        ...
                        <q-item class="q-pa-sm">
                          <q-item-section>
                            <q-item-label class="q-caption">Reference:</q-item-label>
                          </q-item-section>
                          <q-item-section side>
                            <q-item-label class="q-caption">{{formData.shortLead?.referenceNumber == ''?'NA':formData.shortLead?.referenceNumber}}</q-item-label>
                          </q-item-section>
                        </q-item>
                      </q-list>
                      <div v-if="formData.shortLead?.paymentOption == 2" class="q-pa-sm">
                        <div
                      ...
                      <div v-if="showOpenPaymentChequeInfo" class="q-pa-sm">
                        <viewer
                    ...
                    <q-card-section class="q-pa-sm text-grey-9">
                      <q-list separator dense>
                        <q-item>
                          ...
                          <q-item-section side>
                            <q-item-label class="q-caption">{{formData.shortLead?.debitLessthanAmount}}%</q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item>
                          <q-item-section>
                          ...
                          <q-item-section side>
                            <q-item-label class="q-caption">{{formData.shortLead?.debitGreaterthanAmount}}%</q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item>
                          <q-item-section>
                        ...
                        <q-item>
                          ...
                          <q-item-section side>
                            <q-item-label class="q-caption">{{formData.shortLead?.premiumCC}}%</q-item-label>
                          </q-item-section>
                        </q-item>
                        <q-item>
                          <q-item-section>
