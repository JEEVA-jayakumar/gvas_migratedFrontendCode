...
props.row.leadInformation != null ||
props.row.qrLeadInformation != null
"  :props="props">{{ $moment(props.row.createdAt).format("Do MMM Y") }}</q-td>
</template>
...
// // console.log("getimplementationExecutiveSearchList-------->>>>",JSON.stringify(getimplementationExecutiveSearchList))
// // this.IMPLEMENTATION_EXECUTIVE_SEARCH_LIST(val).then(response => {
// // // console.log("getimplementationExecutiveSearchList1-------->>>>",JSON.stringify(getimplementationExecutiveSearchList))
