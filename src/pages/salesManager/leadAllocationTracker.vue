  ...
  <q-page>
    <div>
      ...
      <q-table
        ...
        row-key="name"
      >
        <template v-slot:body-cell-dateCreated="props"><q-td :props="props">{{ $moment(props.row.createdAt).format("Do MMM Y") }}</q-td></template>
        ...
        <template v-slot:body-cell-leadId="props"><q-td :props="props"
          class="cursor-pointer"
          @click="toggleLeadInformation(props.row)">
          <span class="text-primary cursor-pointer"># {{ props.row.leadNumber}}</span>
        </q-td></template>
        <template v-slot:body-cell-leadAddress="props"><q-td class="breakAll"

          :props="props">{{props.row.leadAddress}}</q-td></template>
        <template v-slot:body-cell-assignedTo="props"><q-td :props="props">{{props.row.assignedTo == null? 'NA':props.row.assignedTo.name}}</q-td></template>
